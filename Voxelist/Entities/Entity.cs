...
namespace Voxelist.Entities
{
    public abstract class Entity
    {
        ...
        /// Default is yes, unless other == this.  Strange effects will occur if
        ...
        private void MoveAndResolveCollisions(Vector3 intendedChange)
        {
            ...
            intendedChange.X = ResolveCollisions(Position.chunkX, Position.chunkZ, BoundingBox, intendedChange.X, ref collidedX, Dimension.X);
            ...
            intendedChange.Y = ResolveCollisions(Position.chunkX, Position.chunkZ, BoundingBox, intendedChange.Y, ref collidedY, Dimension.Y);
            ...
            intendedChange.Z = ResolveCollisions(Position.chunkX, Position.chunkZ, BoundingBox, intendedChange.Z, ref collidedZ, Dimension.Z);
        ...
        private IEnumerable<BoundingBox> PossibleCollisions(int chunkX, int chunkZ, BoundingBox currentBoundingBox)
        {
            if (CollidesWithMapGeometry)
            {
                foreach (BoundingBox box in Map.IntersectingBlockBoxes(chunkX, chunkZ, currentBoundingBox))
                    yield return box;
            }
        ...
        private const bool UseSloppyCollisionResolution = true;
        ...
        /// <returns></returns>
        public float ResolveCollisions(int chunkX, int chunkZ, BoundingBox startingBox, float originalIntendedChange, ref bool collided, Dimension movementDimension)
        {
            ...
            foreach (BoundingBox blockBounds in PossibleCollisions(chunkX, chunkZ, stretchedBox))
            {
                collided = true;
                    ...
                    case Sign.Positive:
                        switch (movementDimension)
                        {
                            case Dimension.X:
                                ...
                                relevantChange = stretchedBox.Max.X - startingBox.Max.X - GameConstants.PHYSICS_EPSILON;
                                break;
                            ...
                            case Dimension.Y:
                                ...
                                relevantChange = stretchedBox.Max.Y - startingBox.Max.Y - GameConstants.PHYSICS_EPSILON;
                                break;
                            ...
                            case Dimension.Z:
                                ...
                                relevantChange = stretchedBox.Max.Z - startingBox.Max.Z - GameConstants.PHYSICS_EPSILON;
                                break;
                    ...
                    case Sign.Negative:
                        switch (movementDimension)
                        {
                            case Dimension.X:
                                ...
                                relevantChange = stretchedBox.Min.X - startingBox.Min.X + GameConstants.PHYSICS_EPSILON;
                                break;
                            ...
                            case Dimension.Y:
                                ...
                                relevantChange = stretchedBox.Min.Y - startingBox.Min.Y + GameConstants.PHYSICS_EPSILON;
                                break;
                            ...
                            case Dimension.Z:
                                ...
                                relevantChange = stretchedBox.Min.Z - startingBox.Min.Z + GameConstants.PHYSICS_EPSILON;
                                break;
